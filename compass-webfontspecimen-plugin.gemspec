...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/wfs/compass_plugin.rb", "lib/wfs/sass_extensions.rb", "lib/wfs.rb", "Manifest", "Rakefile", "README.mkdn", "sass/wfs/_font_face.sass", "sass/wfs/_960.sass", "sass/wfs/_base.sass", "templates/project/wfs.sass", "templates/project/wfs.html", "templates/project/manifest.rb", "VERSION", "LICENSE.txt", "compass-webfontspecimen-plugin.gemspec"]
